...
if __name__ == '__main__':
    ...
    #print hostinfo 
    data_urlencode = urllib.urlencode(hostinfo)
    requrl = '/cmdb/hardwareinfo/'
    headers = {"Content-Type":"application/x-www-form-urlencoded","Accept": "text/json",
"User-Agent":"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36",
"Host":"192.168.52.6","Securtykey":securty.create_api_key()}
    conn = httplib.HTTPConnection("192.168.52.6",8888)
    conn.request(method="POST",url=requrl,body=data_urlencode,headers=headers) 
    response = conn.getresponse()
    print securty.create_api_key()
